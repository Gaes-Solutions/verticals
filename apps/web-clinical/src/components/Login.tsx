...
/** En producción el slug sale del subdominio (clinica.gaessoft.mx); en localhost/IP se pide. */
function tenantDeSubdominio(): string | null {
  ...
  const sub = parts[0];
  const reservados = ["www", "admin", "app", "pos", "clinica"];
  ...
  return (
    <div className="flex h-full items-center justify-center p-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-lg">
        <h1 className="mb-1 font-bold text-2xl text-brand">GaesSoft Clínica</h1>
        <p className="mb-6 text-slate-500 text-sm">Inicia sesión para atender</p>
