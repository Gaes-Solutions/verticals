...
import comisionesRoutes from "./modules/tenant/comisiones/routes.js";
...
import vendedorRoutes from "./modules/tenant/vendedor/routes.js";
import ventasRoutes from "./modules/tenant/ventas/routes.js";
import visitasRoutes from "./modules/tenant/visitas/routes.js";
...
export async function buildApp(
  ...
  await app.register(
    async (tenantApp) => {
      ...
      await tenantApp.register(comisionesRoutes, { prefix: "/comisiones" });
      await tenantApp.register(visitasRoutes, { prefix: "/visitas" });
      await tenantApp.register(vendedorRoutes, { prefix: "/vendedor" });
