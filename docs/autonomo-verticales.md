...
|---|----------|--------|-------|
| 1 | Abarrotes (flujo 2 / 4.14) | 🟡 en curso | Admin campos balanza+IEPS ✅ (c5c71fe). Ticket IEPS/IVA (+fix $NaN) ✅ (c581828). Recargas/servicios en POS ✅ (87b0e26). FALTA: fiado/CxC en CobroModal, apartados, captura de peso (balanza) en línea de venta |
