...
|---|----------|--------|-------|
| 1 | Abarrotes (flujo 2 / 4.14) | 🟡 en curso | Admin campos balanza+IEPS ✅ (c5c71fe). Ticket IEPS/IVA (+fix $NaN) ✅ (c581828). Recargas/servicios POS ✅ (87b0e26). Fiado/CxC en cobro ✅ (d141730). FALTA: apartados, captura de peso (balanza) en línea de venta |
